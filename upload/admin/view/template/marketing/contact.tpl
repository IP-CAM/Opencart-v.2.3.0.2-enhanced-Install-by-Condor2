...
$('#input-customer').parent().find('.well').on('click', '.fa-minus-circle', function() {
	$(this).parent().remove();
});
...
$('#input-affiliate').parent().find('.well').on('click', '.fa-minus-circle', function() {
	$(this).parent().remove();
});
...
$('#input-product').parent().find('.well').on('click', '.fa-minus-circle', function() {
	$(this).parent().remove();
});
